...
#Clasificacion de archivos a eliminar
tryCatch({
  ...
  log_error("Borrado Samba — Error al clasificar archivos: {conditionMessage(e)}")
  q001Validos   <<- data.frame()
  q001Invalidos <<- data.frame()
...
tryCatch({
  ...
  log_error("Borrado Samba — Error al eliminar archivos: {conditionMessage(e)}")
